...
public class MainMenuButtons {
    ...
    public MainMenuButtons(GameMain game) {
        ...
        gameViewport = new FitViewport(GameInfo.WIDTH, GameInfo.HIGHT,
    ...
    void createAndPositionButtons() {
        ...
        playBtn.setPosition(GameInfo.WIDTH / 2f - 100, GameInfo.HIGHT / 2f - 50,
                Align.center);

        scoreBtn.setPosition(GameInfo.WIDTH / 2f + 100, GameInfo.HIGHT / 2f - 50,
                Align.center);
    ...
    void changeBird(){
        ...
        changeBirdBtn = new ImageButton(new SpriteDrawable(new Sprite(
                new Texture("Birds/" + GameManager.getInstance().getBird() + "/Idle.png"))));

        changeBirdBtn.setPosition(GameInfo.WIDTH / 2f, GameInfo.HIGHT / 2f + 200, Align.center);
    ...
    void showScore(){
        ...
        scoreLabel.setPosition(GameInfo.WIDTH / 2f, GameInfo.HIGHT / 2f - 200, Align.center);
